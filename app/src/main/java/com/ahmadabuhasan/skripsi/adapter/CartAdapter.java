...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        textView.setText(this.context.getString(R.string.total_price) + currency + this.decimalFormat.format(total_price));
        ...
        textView2.setText(currency + this.decimalFormat.format(getPrice));
        ...
        holder.imgDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (databaseAccess.deleteProductFromCart(cart_id)) {
                    ...
                    textView.setText(CartAdapter.this.context.getString(R.string.total_price) + currency + CartAdapter.this.decimalFormat.format(CartAdapter.total_price));
                } else {
        ...
        holder.textView_Minus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (get_qty >= 2) {
                    ...
                    holder.textView_Price.setText(currency + CartAdapter.this.decimalFormat.format(cost));
                    ...
                    CartAdapter.this.textView_total_price.setText(CartAdapter.this.context.getString(R.string.total_price) + currency + CartAdapter.this.decimalFormat.format(CartAdapter.total_price));
                }
        ...
        holder.textView_Plus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                textView.setText(currency + CartAdapter.this.decimalFormat.format(cost));
                ...
                textView3.setText(CartAdapter.this.context.getString(R.string.total_price) + currency + CartAdapter.this.decimalFormat.format(CartAdapter.total_price));
            }
        });
    }
