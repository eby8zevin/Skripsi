...
public class DatabaseOpenHelper extends SQLiteOpenHelper {
    ...
    public static final String COMPLETED = "Selesai";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("INSERT INTO " + TABLE_ORDER_TYPE + "(order_type_id, order_type_name) VALUES (1, 'AMBIL SENDIRI')");
        db.execSQL("INSERT INTO " + TABLE_ORDER_TYPE + "(order_type_id, order_type_name) VALUES (2, 'PENGIRIMAN')");
        db.execSQL("INSERT INTO " + TABLE_ORDER_TYPE + "(order_type_id, order_type_name) VALUES (3, 'KURIR')");
