    ...
    public void insertOrder(String paramString, JSONObject paramJSONObject) {
        ...
        try {
            ...
            while (i < result.length()) {
                ...
                str15 = str16;
                str17 = jo.getString(ORDER_DETAILS_PRODUCT_PRICE);
                contentValues = contentValues4;
                str16 = jo.getString(contentValues);
                contentValues4 = values;
                jSONArray = jSONArray2;
                values2 = jo.getString(jSONArray);
                jSONArray2 = result;
                result = jo.getString(PRODUCT_ID);
                i2 = i;
                str2 = jo.getString("stock");
                updated_stock = Integer.parseInt(str2) - Integer.parseInt(str14);
                contentValues2 = values24;
                ...
                values22.put(ORDER_DETAILS_PRODUCT_QTY, str14);
                str2 = str17;
                values22.put(ORDER_DETAILS_PRODUCT_PRICE, str2);
                str17 = str2;
                str2 = str16;
                values22.put(contentValues, str2);
                str16 = str2;
                str2 = values2;
                values22.put(jSONArray, str2);
                values22.put(ORDER_DETAILS_ORDER_STATUS, "Pending");
                values2 = str2;
                contentValues3 = contentValues;
                customer_name = str3;
                values3 = values32;
        ...
        public void proceedOrder(String type, String payment_method, String customer_name, double calculated_tax, String discount) {
            ...
            String str2 = Constant.PRODUCT_PRICE;
            String str3 = "stock";
            String str4 = Constant.PRODUCT_QTY;
            String str5 = Constant.PRODUCT_WEIGHT;
            String str6 = Constant.PRODUCT_ID;
            ...
            if (itemCount > 0) {
                ...
                if (lines.isEmpty()) {
                    Toasty.error(context, R.string.no_product_found, 0).show();
                    databaseAccess2 = databaseAccess;
                    i = itemCount;
                } else {
                    ...
                    try {
                        ...
                        try {
                            obj.put(Constant.ORDER_PAYMENT_METHOD, payment_method);
                            obj.put(Constant.CUSTOMER_NAME, customer_name);
                            try {
                                obj.put(Constant.TAX, calculated_tax);
                                obj.put(Constant.DISCOUNT, discount);
                                JSONArray array = new JSONArray();
                                itemCount = 0;
                                while (itemCount < lines.size()) {
                                    databaseAccess.open();
                                    currentTime = (String) ((HashMap) lines.get(itemCount)).get(str6);
                                    tsLong = databaseAccess.getProductName(currentTime);
                                    databaseAccess.open();
                                    timeStamp2 = timeStamp;
                                    try {
                                        String weight_unit = databaseAccess.getWeightUnitName((String) ((HashMap) lines.get(itemCount)).get(Constant.PRODUCT_WEIGHT_UNIT));
                                        databaseAccess.open();
                                        String product_image = databaseAccess.getProductImage(currentTime);
                                        JSONObject objp = new JSONObject();
                                        databaseAccess2 = databaseAccess;
                                        JSONObject objp2 = objp;
                                        objp2.put(str6, currentTime);
                                        String str7 = str6;
                                        objp2.put(Constant.PRODUCT_NAME, tsLong);
                                        StringBuilder stringBuilder = new StringBuilder();
                                        stringBuilder.append((String) ((HashMap) lines.get(itemCount)).get(str5));
                                        stringBuilder.append(" ");
                                        stringBuilder.append(weight_unit);
                                        objp2.put(str5, stringBuilder.toString());
                                        objp2.put(str4, ((HashMap) lines.get(itemCount)).get(str4));
                                        objp2.put(str3, ((HashMap) lines.get(itemCount)).get(str3));
                                        objp2.put(str2, ((HashMap) lines.get(itemCount)).get(str2));
                                        objp2.put(Constant.PRODUCT_IMAGE, product_image);
                                        objp2.put(Constant.PRODUCT_ORDER_DATE, currentDate);
                                        array.put(objp2);
                                        itemCount++;
                                        weight_unit = type;
                                        currentTime = calculated_tax;
                                        databaseAccess = databaseAccess2;
            ...
            i = itemCount;
            Toasty.error(context, R.string.no_product_in_cart, 0).show();
        }
